...
describe("чтение координат", () => {
  it("называет полушария буквами, а не минусом", () => {
    expect(formatCoordinates(55.7558, 37.6173)).toBe("55.76° с. ш. · 37.62° в. д.");
    expect(formatCoordinates(-33.8688, -70.6693)).toBe("33.87° ю. ш. · 70.67° з. д.");
  });

  it("ноль относит к северу и востоку, а не к пустоте", () => {
    expect(formatCoordinates(0, 0)).toBe("0.00° с. ш. · 0.00° в. д.");
  });
});
