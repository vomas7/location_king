...
export const ru = {
  ...
  landing: {
    ...
    titleTop: "Земля сверху.",
    titleBottom: "Где это?",
    lead:
      "Подписи, указатели, координаты — ничего этого нет. Найди это место на карте мира. " +
      "Арифметика простая: промах в километр стоит почти пять тысяч очков, промах в " +
