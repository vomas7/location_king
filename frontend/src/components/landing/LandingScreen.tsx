      ...
      <section className={[styles.band, styles.fair].join(" ")}>
        <div>
          ...
          <p className={styles.fairText}>
            На лёгком достаются всемирно известные города — Париж, Токио, Нью-Йорк. Дальше любой
            город мира, потом поля и дельты без единой вывески. На хардкоре остаются горы, пустыни и
