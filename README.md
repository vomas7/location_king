...
| Уровень   | Что показывают                                    |
|-----------|---------------------------------------------------|
| Легко     | всемирно известные города — Париж, Токио, Нью-Йорк |
| Средне    | любой город и городской объект                     |
| Сложно    | обжитая местность без города: поля, дельты, острова |
| Хардкор   | дикая природа: горы, пустыни, тайга, лёд           |

Уровню соответствует набор категорий зон — соответствие лежит в
`app/models/enums.py`, «легко» задаётся отдельной подборкой известных городов.
Радиус городской зоны ограничен десятью километрами, чтобы точка раунда не
уходила за окраину; у диких зон разброс больше — это часть замысла. Оба
