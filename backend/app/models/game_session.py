...
from sqlalchemy import DateTime, Float, ForeignKey, Integer, SmallInteger, String, func, Text
...
class GameSession(Base):
    ...
    time_control: Mapped[str] = mapped_column(
        String(20), nullable=False, default=TimeControl.UNLIMITED
    )
    ...
    def get_average_distance(self) -> Optional[float]:
    ...
    def get_time_per_round(self) -> Optional[float]:
