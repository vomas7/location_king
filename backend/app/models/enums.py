...
class AnswerMode(StrEnum):
    ...
    Точкой — обычная игра: очки за расстояние до цели. Страной — тот же
    снимок и та же карта, но засчитывается попадание в страну, а не в точку.
    Ставит игрок в обоих случаях точку: в режиме стран сервер сам смотрит, в
    какую страну она попала.
    """
