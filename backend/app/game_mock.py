...
class RoundResponse(BaseModel):
    ...
    target_point: Point
    guess_point: Optional[Point] = None
...
async def get_round(round_id: str):
    ...
    return RoundResponse(
        ...
        guess_point=Point(lat=round_obj["guess_lat"], lon=round_obj["guess_lon"]) if "guess_lat" in round_obj else None,
        distance_meters=round_obj.get("distance_meters"),
        score=round_obj.get("score"),
        created_at=round_obj["created_at"].isoformat() + "Z",
        completed_at=round_obj["completed_at"].isoformat() + "Z" if "completed_at" in round_obj else None
    )
