...
class Settings(BaseSettings):
    ...
    # ── Дуэли ────────────────────────────────────────────────────────────
    # Соперники-боты. Нужны, пока живых игроков мало и очередь дуэлей пустая:
    # без них человек жмёт «найти соперника» и упирается в тишину. Бот всегда
    # назван ботом, рейтинга не двигает и в счётчик игроков не попадает.
    # Когда очередь наполнится живыми, выключается этой строкой.
    duel_bots_enabled: bool = True
