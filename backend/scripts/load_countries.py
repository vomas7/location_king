...
Разрешение в пять километров выбрано не на глаз: на нём 271 зона каталога из
277 получает страну, совпадающую с записанной руками, а на километровом —
272. Одна зона не стоит одиннадцатикратного веса: два мегабайта против
двадцати двух. Что за шесть зон выпадает и почему — в README.
