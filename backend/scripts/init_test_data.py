    ...
    async with async_session() as session:
        try:
            ...
            moscow_zone = LocationZone(
                ...
                category="city",
                polygon=WKTElement(
                    "POLYGON((37.3 55.6, 37.3 55.9, 38.0 55.9, 38.0 55.6, 37.3 55.6))", srid=4326
                ),
                is_active=True,
            )
            ...
            spb_zone = LocationZone(
                ...
                category="city",
                polygon=WKTElement(
                    "POLYGON((30.0 59.8, 30.0 60.1, 30.5 60.1, 30.5 59.8, 30.0 59.8))", srid=4326
                ),
                is_active=True,
            )
            ...
            sochi_zone = LocationZone(
                ...
                category="coast",
                polygon=WKTElement(
                    "POLYGON((39.5 43.4, 39.5 43.7, 40.0 43.7, 40.0 43.4, 39.5 43.4))", srid=4326
                ),
                is_active=True,
            )
            ...
            gobi_zone = LocationZone(
                ...
                category="desert",
                polygon=WKTElement(
                    "POLYGON((90.0 40.0, 90.0 45.0, 110.0 45.0, 110.0 40.0, 90.0 40.0))", srid=4326
                ),
                is_active=True,
            )
            ...
            europe_zone = LocationZone(
                ...
                category="mixed",
                polygon=WKTElement(
                    "POLYGON((5.0 45.0, 5.0 55.0, 15.0 55.0, 15.0 45.0, 5.0 45.0))", srid=4326
                ),
                is_active=True,
            )
